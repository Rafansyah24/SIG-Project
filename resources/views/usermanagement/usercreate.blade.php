            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ url('users/add/save') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
                            ...
                            <button type="submit" class="btn btn-primary">Add User</button><button type="button" class="btn btn-light" style="margin-left: 7px;"><a href="{{ route('users/list/page') }}" style="text-decoration: none;">Back</a></button>
                        </form>
                    </div>
                </div>
            </div>
